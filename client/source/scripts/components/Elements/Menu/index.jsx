            ...
            <ResponsiveMenu
                ...
                menu={
                    <ul>
                        ...
                        <li>
                            <NavLink activeClassName={styles.active} to={"/agencies"}>
                                Agencies
                            </NavLink>
                        </li>
                        <li>
                            <NavLink activeClassName={styles.active} to={"/candidates"}>
                                Candidates
                            </NavLink>
                        </li>
                        <li>
                            <NavLink activeClassName={styles.active} to={"/jobs"}>
                                Jobs
                            </NavLink>
                        </li>
                        <li>
                            <NavLink activeClassName={styles.active} to={"/administration"}>
                                Administration
                            </NavLink>
                        </li>
                        <li>
