...
class ProfileQuestionGroups extends Component {
    ...
    render(){
        ...
        let menuActions = [
            {caption:"Edit Question", onClick:(id) => this.props.history.push(`/administration/groupquestion/edit/${id}`), warning:false},
        ];

        return(
            <Main>
                <ToolBar>
                    <BackButton onClick={() => this.props.history.replace('/administration/profilequestiongroups')}/>

                    <div>Group Questions</div>

                    <ToolbarButton caption={'New'} onClick={() => this.props.history.push(`/administration/groupquestion/create/${groupId}`)}/>
                </ToolBar>
                <Content>
                    <VerticalMenu
                        ...
                        defaultAction={(id) => this.props.history.push(`/administration/questionanswers/${groupId}/${id}`)}
