...
class ProfileQuestionGroups extends Component {
    ...
    render(){
        ...
        let menuActions = [
            {caption:"Edit Group", onClick:(id) => this.props.history.push(`/administration/profilequestiongroup/edit/${id}`), warning:false},
        ];

        return(
            <Main>
                <ToolBar>
                    <BackButton onClick={() => this.props.history.replace('/administration/administration')}/>

                    <div>Question Groups</div>

                    <ToolbarButton caption={'New'} onClick={() => this.props.history.push(`/administration/profilequestiongroup/create`)}/>
                </ToolBar>
                <Content>
                    <VerticalMenu
                        ...
                        idField="Id"
                        captionField="Name"
                        defaultAction={(id) => this.props.history.push(`/administration/groupquestions/${id}`)}
