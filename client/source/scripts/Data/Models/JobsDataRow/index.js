...
class JobsDataRow extends DataRow{
    ...
    addFields(data){
        ...
        this.addField(new DataField("SchoolId", "number", data["SchoolId"], false));
        this.addField(new DataField("Name", "string", data["Name"], false));
        this.addField(new DataField("Created", "string", data["Created"], false, true));
        this.addField(new DataField("Updated", "string", data["Updated"], false));
    }

    addValidation(){
        this.validators["Id"] = new FieldValidator();
        this.validators["AgencyId"] = new FieldValidator();
        this.validators["SchoolId"] = new FieldValidator();
